...
public interface GEAPackage extends GIdentifiable {
	 ...
	 * {@link org.eclipse.eatop.geastadl.ginfrastructure.gelements.GEAPackageableElement}. It is bidirectional and its
	 * opposite is '
	 * {@link org.eclipse.eatop.geastadl.ginfrastructure.gelements.GEAPackageableElement#getGEAPackage_element <em>GEA
	 * Package element</em>}'. <!-- begin-user-doc -->
	 * <p>
	 ...
	 */
	default EList<GEAPackageableElement> gGetElement() {
		return null;
	}
	 ...
	 */
	default EList<GEAPackage> gGetSubPackage() {
		return null;
	}
