package org.bumble.eastadl.simplified.ide.server;
...
/**
 * Launcher to run the Xtext Language Server for EAST-ADL stand-alone.
 * Based on: {@link https://github.com/itemis/xtext-languageserver-example/blob/master/org.xtext.example.mydsl.ide/src/org/xtext/example/mydsl/ide/RunServer.java}
