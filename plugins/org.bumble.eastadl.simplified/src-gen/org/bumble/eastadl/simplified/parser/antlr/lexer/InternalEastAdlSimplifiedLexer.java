...
public class InternalEastAdlSimplifiedLexer extends Lexer {
    ...
    public static final int RULE_EABINARY=237;
    ...
    public static final int RULE_EAOCTAL=238;
    ...
    public static final int RULE_EAHEX=239;
    public static final int RULE_EAEXPONENT=240;
    ...
    public final void mRULE_EABINARY() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEastAdlSimplifiedLexer.g:480:15: ( '0b' ( '0' .. '1' )* )
            // InternalEastAdlSimplifiedLexer.g:480:17: '0b' ( '0' .. '1' )*
            {
            match("0b"); 

            // InternalEastAdlSimplifiedLexer.g:480:22: ( '0' .. '1' )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalEastAdlSimplifiedLexer.g:480:23: '0' .. '1'
            	    {
            	    matchRange('0','1'); 
    ...
    public final void mRULE_EAOCTAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEastAdlSimplifiedLexer.g:482:14: ( '0' '1' .. '7' ( '0' .. '7' )* )
            // InternalEastAdlSimplifiedLexer.g:482:16: '0' '1' .. '7' ( '0' .. '7' )*
            {
            match('0'); 
            matchRange('1','7'); 
            // InternalEastAdlSimplifiedLexer.g:482:29: ( '0' .. '7' )*
            loop2:
            do {
                int alt2=2;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalEastAdlSimplifiedLexer.g:482:30: '0' .. '7'
            	    {
            	    matchRange('0','7'); 
    ...
    public final void mRULE_EAHEX() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEastAdlSimplifiedLexer.g:484:12: ( '0x' ( '0' .. '9' | 'a' .. 'f' )* )
            // InternalEastAdlSimplifiedLexer.g:484:14: '0x' ( '0' .. '9' | 'a' .. 'f' )*
            {
            match("0x"); 

            // InternalEastAdlSimplifiedLexer.g:484:19: ( '0' .. '9' | 'a' .. 'f' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_EAEXPONENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEastAdlSimplifiedLexer.g:486:17: ( ( '0' .. '9' )+ ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            // InternalEastAdlSimplifiedLexer.g:486:19: ( '0' .. '9' )+ ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
            {
            // InternalEastAdlSimplifiedLexer.g:486:19: ( '0' .. '9' )+
            int cnt4=0;
            loop4:
            do {
                int alt4=2;
                ...
                switch (alt4) {
            	case 1 :
            	    // InternalEastAdlSimplifiedLexer.g:486:20: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
            ...
            // InternalEastAdlSimplifiedLexer.g:486:41: ( '+' | '-' )?
            int alt5=2;
            ...
            // InternalEastAdlSimplifiedLexer.g:486:52: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
            do {
                int alt6=2;
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalEastAdlSimplifiedLexer.g:486:53: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
