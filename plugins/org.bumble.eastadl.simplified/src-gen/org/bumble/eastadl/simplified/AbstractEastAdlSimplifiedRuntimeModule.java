...
import org.bumble.eastadl.simplified.validation.EastAdlSimplifiedConfigurableIssueCodesProvider;
import org.bumble.eastadl.simplified.validation.EastAdlSimplifiedValidator;
...
public abstract class AbstractEastAdlSimplifiedRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/bumble/eastadl/simplified/EastAdlSimplified.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.bumble.eastadl.simplified.EastAdlSimplified");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("eatxt");
	}
	...
	public Class<? extends IGrammarAccess> bindIGrammarAccess() {
		return EastAdlSimplifiedGrammarAccess.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISemanticSequencer> bindISemanticSequencer() {
		return EastAdlSimplifiedSemanticSequencer.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISyntacticSequencer> bindISyntacticSequencer() {
		return EastAdlSimplifiedSyntacticSequencer.class;
	}
	...
	public Class<? extends IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return EastAdlSimplifiedAntlrTokenFileProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Class<? extends Lexer> bindLexer() {
		return InternalEastAdlSimplifiedLexer.class;
	}
	...
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Provider<? extends InternalEastAdlSimplifiedLexer> provideInternalEastAdlSimplifiedLexer() {
		return LexerProvider.create(InternalEastAdlSimplifiedLexer.class);
	}
	...
	public Class<? extends EastAdlSimplifiedValidator> bindEastAdlSimplifiedValidator() {
		return EastAdlSimplifiedValidator.class;
	}
