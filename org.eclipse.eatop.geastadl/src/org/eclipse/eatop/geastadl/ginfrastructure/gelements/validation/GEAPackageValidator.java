...
/**
 * A sample validator interface for {@link org.eclipse.eatop.geastadl.ginfrastructure.gelements.GEAPackage}. This doesn't really do
 ...
 */
public interface GEAPackageValidator {
	boolean validate();

	boolean validateGElement(EList<GEAPackageableElement> value);

	boolean validateGSubPackage(EList<GEAPackage> value);
}
