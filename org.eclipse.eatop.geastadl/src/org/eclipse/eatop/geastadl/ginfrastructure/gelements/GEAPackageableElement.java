 ...
 * <ul>
 * <li>{@link org.eclipse.eatop.geastadl.ginfrastructure.gelements.GEAPackageableElement#getGEAPackage_element <em>GEA
 * Package element</em>}</li>
 * </ul>
 * </p>
 *
...
public interface GEAPackageableElement extends GIdentifiable {
	 ...
	 * opposite is '{@link org.eclipse.eatop.geastadl.ginfrastructure.gelements.GEAPackage#getGElement
	 * <em>GElement</em>}'. <!-- begin-user-doc -->
	 * <p>
	 ...
	 */
	default GEAPackage gGetEAPackage_element() {
		return null;
	}

	/**
	 * Sets the value of the
	 * '{@link org.eclipse.eatop.geastadl.ginfrastructure.gelements.GEAPackageableElement#gGetEAPackage_element <em>GEA
	 * Package element</em>}' container reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @param value
	 *            the new value of the '<em>GEA Package element</em>' container reference.
	 * @see #gGetEAPackage_element()
	 */
	default void gSetEAPackage_element(GEAPackage value) {
