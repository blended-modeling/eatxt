 ...
 * </p>
 * <ul>
 *   <li>{@link eastadl22_alpha.Context#getTraceableSpecification <em>Traceable Specification</em>}</li>
 *   <li>{@link eastadl22_alpha.Context#getOwnedRelationship <em>Owned Relationship</em>}</li>
 * </ul>
 *
 * @see eastadl22_alpha.Eastadl22_alphaPackage#getContext()
 * @model abstract="true"
...
public interface Context extends EAPackageableElement {
	 ...
	 * The list contents are of type {@link eastadl22_alpha.TraceableSpecification}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Traceable Specification</em>' reference list.
	 * @see eastadl22_alpha.Eastadl22_alphaPackage#getContext_TraceableSpecification()
	 ...
	 * The list contents are of type {@link eastadl22_alpha.Relationship}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Owned Relationship</em>' containment reference list.
	 * @see eastadl22_alpha.Eastadl22_alphaPackage#getContext_OwnedRelationship()
