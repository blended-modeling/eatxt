 ...
 * </p>
 * <ul>
 *   <li>{@link eastadl22_alpha.impl.EACompositeValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EACompositeValueImpl extends EAValueImpl implements EACompositeValue {
	...
	protected EClass eStaticClass() {
		return Eastadl22_alphaPackage.Literals.EA_COMPOSITE_VALUE;
	}
	...
	public EList<EAValue> getValue() {
		if (value == null) {
			value = new EObjectContainmentEList<EAValue>(EAValue.class, this, Eastadl22_alphaPackage.EA_COMPOSITE_VALUE__VALUE);
		}
		return value;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Eastadl22_alphaPackage.EA_COMPOSITE_VALUE__VALUE:
