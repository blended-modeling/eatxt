 ...
 * </p>
 * <ul>
 *   <li>{@link eastadl22_alpha.impl.FunctionAllocationImpl#getAllocatedElement <em>Allocated Element</em>}</li>
 *   <li>{@link eastadl22_alpha.impl.FunctionAllocationImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionAllocationImpl extends EAElementImpl implements FunctionAllocation {
	...
	protected EClass eStaticClass() {
		return Eastadl22_alphaPackage.Literals.FUNCTION_ALLOCATION;
	}
	...
	public NotificationChain basicSetAllocatedElement(FunctionAllocation_allocatedElement newAllocatedElement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.FUNCTION_ALLOCATION__ALLOCATED_ELEMENT, oldAllocatedElement, newAllocatedElement);
	...
	public void setAllocatedElement(FunctionAllocation_allocatedElement newAllocatedElement) {
		if (newAllocatedElement != allocatedElement) {
			...
			if (allocatedElement != null)
				msgs = ((InternalEObject)allocatedElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Eastadl22_alphaPackage.FUNCTION_ALLOCATION__ALLOCATED_ELEMENT, null, msgs);
			if (newAllocatedElement != null)
				msgs = ((InternalEObject)newAllocatedElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Eastadl22_alphaPackage.FUNCTION_ALLOCATION__ALLOCATED_ELEMENT, null, msgs);
			msgs = basicSetAllocatedElement(newAllocatedElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.FUNCTION_ALLOCATION__ALLOCATED_ELEMENT, newAllocatedElement, newAllocatedElement));
	}
	...
	public NotificationChain basicSetTarget(FunctionAllocation_target newTarget, NotificationChain msgs) {
		...
		target = newTarget;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.FUNCTION_ALLOCATION__TARGET, oldTarget, newTarget);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTarget(FunctionAllocation_target newTarget) {
		if (newTarget != target) {
			NotificationChain msgs = null;
			if (target != null)
				msgs = ((InternalEObject)target).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Eastadl22_alphaPackage.FUNCTION_ALLOCATION__TARGET, null, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject)newTarget).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Eastadl22_alphaPackage.FUNCTION_ALLOCATION__TARGET, null, msgs);
			msgs = basicSetTarget(newTarget, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.FUNCTION_ALLOCATION__TARGET, newTarget, newTarget));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Eastadl22_alphaPackage.FUNCTION_ALLOCATION__ALLOCATED_ELEMENT:
				return basicSetAllocatedElement(null, msgs);
			case Eastadl22_alphaPackage.FUNCTION_ALLOCATION__TARGET:
