 ...
 * </p>
 * <ul>
 *   <li>{@link eastadl22_alpha.impl.FunctionPowerPortImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionPowerPortImpl extends FunctionPortImpl implements FunctionPowerPort {
	...
	protected EClass eStaticClass() {
		return Eastadl22_alphaPackage.Literals.FUNCTION_POWER_PORT;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Eastadl22_alphaPackage.FUNCTION_POWER_PORT__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(CompositeDatatype newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.FUNCTION_POWER_PORT__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Eastadl22_alphaPackage.FUNCTION_POWER_PORT__TYPE:
