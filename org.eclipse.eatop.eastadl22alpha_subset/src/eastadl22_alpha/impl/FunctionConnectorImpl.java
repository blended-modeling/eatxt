 ...
 * </p>
 * <ul>
 *   <li>{@link eastadl22_alpha.impl.FunctionConnectorImpl#getPort <em>Port</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionConnectorImpl extends EAElementImpl implements FunctionConnector {
	...
	protected EClass eStaticClass() {
		return Eastadl22_alphaPackage.Literals.FUNCTION_CONNECTOR;
	}
	...
	public EList<FunctionConnector_port> getPort() {
		if (port == null) {
			port = new EObjectContainmentEList<FunctionConnector_port>(FunctionConnector_port.class, this, Eastadl22_alphaPackage.FUNCTION_CONNECTOR__PORT);
		}
		return port;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Eastadl22_alphaPackage.FUNCTION_CONNECTOR__PORT:
