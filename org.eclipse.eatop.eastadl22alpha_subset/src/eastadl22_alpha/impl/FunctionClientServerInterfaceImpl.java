...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Function Client Server Interface</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link eastadl22_alpha.impl.FunctionClientServerInterfaceImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionClientServerInterfaceImpl extends TraceableSpecificationImpl implements FunctionClientServerInterface {
	...
	protected EClass eStaticClass() {
		return Eastadl22_alphaPackage.Literals.FUNCTION_CLIENT_SERVER_INTERFACE;
	}
	...
	public EList<Operation> getOperation() {
		if (operation == null) {
			operation = new EObjectContainmentEList<Operation>(Operation.class, this, Eastadl22_alphaPackage.FUNCTION_CLIENT_SERVER_INTERFACE__OPERATION);
		}
		return operation;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Eastadl22_alphaPackage.FUNCTION_CLIENT_SERVER_INTERFACE__OPERATION:
