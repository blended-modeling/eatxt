 ...
 * </p>
 * <ul>
 *   <li>{@link eastadl22_alpha.impl.HardwareComponentPrototypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HardwareComponentPrototypeImpl extends AllocationTargetImpl implements HardwareComponentPrototype {
	...
	protected EClass eStaticClass() {
		return Eastadl22_alphaPackage.Literals.HARDWARE_COMPONENT_PROTOTYPE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Eastadl22_alphaPackage.HARDWARE_COMPONENT_PROTOTYPE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(HardwareComponentType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.HARDWARE_COMPONENT_PROTOTYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Eastadl22_alphaPackage.HARDWARE_COMPONENT_PROTOTYPE__TYPE:
