 ...
 * </p>
 * <ul>
 *   <li>{@link eastadl22_alpha.impl.EAExpressionImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EAExpressionImpl extends EAValueImpl implements EAExpression {
	...
	protected EClass eStaticClass() {
		return Eastadl22_alphaPackage.Literals.EA_EXPRESSION;
	}
	...
	public EList<EAValue> getValue() {
		if (value == null) {
			value = new EObjectContainmentEList<EAValue>(EAValue.class, this, Eastadl22_alphaPackage.EA_EXPRESSION__VALUE);
		}
		return value;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Eastadl22_alphaPackage.EA_EXPRESSION__VALUE:
