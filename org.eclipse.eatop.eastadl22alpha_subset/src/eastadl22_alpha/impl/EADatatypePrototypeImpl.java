 ...
 * </p>
 * <ul>
 *   <li>{@link eastadl22_alpha.impl.EADatatypePrototypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EADatatypePrototypeImpl extends EAElementImpl implements EADatatypePrototype {
	...
	protected EClass eStaticClass() {
		return Eastadl22_alphaPackage.Literals.EA_DATATYPE_PROTOTYPE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Eastadl22_alphaPackage.EA_DATATYPE_PROTOTYPE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(EADatatype newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.EA_DATATYPE_PROTOTYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Eastadl22_alphaPackage.EA_DATATYPE_PROTOTYPE__TYPE:
