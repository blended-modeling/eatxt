 ...
 * </p>
 * <ul>
 *   <li>{@link eastadl22_alpha.impl.FunctionTypeImpl#getIsElementary <em>Is Elementary</em>}</li>
 *   <li>{@link eastadl22_alpha.impl.FunctionTypeImpl#getPortGroup <em>Port Group</em>}</li>
 *   <li>{@link eastadl22_alpha.impl.FunctionTypeImpl#getConnector <em>Connector</em>}</li>
 *   <li>{@link eastadl22_alpha.impl.FunctionTypeImpl#getPort <em>Port</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class FunctionTypeImpl extends ContextImpl implements FunctionType {
	...
	protected EClass eStaticClass() {
		return Eastadl22_alphaPackage.Literals.FUNCTION_TYPE;
	}
	...
	public void setIsElementary(Boolean newIsElementary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.FUNCTION_TYPE__IS_ELEMENTARY, oldIsElementary, isElementary, !oldIsElementaryESet));
	}
	...
	public void unsetIsElementary() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Eastadl22_alphaPackage.FUNCTION_TYPE__IS_ELEMENTARY, oldIsElementary, IS_ELEMENTARY_EDEFAULT, oldIsElementaryESet));
	}
	...
	public EList<PortGroup> getPortGroup() {
		if (portGroup == null) {
			portGroup = new EObjectContainmentEList<PortGroup>(PortGroup.class, this, Eastadl22_alphaPackage.FUNCTION_TYPE__PORT_GROUP);
		}
		return portGroup;
	}
	...
	public EList<FunctionConnector> getConnector() {
		if (connector == null) {
			connector = new EObjectContainmentEList<FunctionConnector>(FunctionConnector.class, this, Eastadl22_alphaPackage.FUNCTION_TYPE__CONNECTOR);
		}
		return connector;
	}
	...
	public EList<FunctionPort> getPort() {
		if (port == null) {
			port = new EObjectContainmentEList<FunctionPort>(FunctionPort.class, this, Eastadl22_alphaPackage.FUNCTION_TYPE__PORT);
		}
		return port;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Eastadl22_alphaPackage.FUNCTION_TYPE__PORT_GROUP:
				return ((InternalEList<?>)getPortGroup()).basicRemove(otherEnd, msgs);
			case Eastadl22_alphaPackage.FUNCTION_TYPE__CONNECTOR:
				return ((InternalEList<?>)getConnector()).basicRemove(otherEnd, msgs);
			case Eastadl22_alphaPackage.FUNCTION_TYPE__PORT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Eastadl22_alphaPackage.FUNCTION_TYPE__IS_ELEMENTARY:
