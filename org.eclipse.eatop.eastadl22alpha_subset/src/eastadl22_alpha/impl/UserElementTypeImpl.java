 ...
 * </p>
 * <ul>
 *   <li>{@link eastadl22_alpha.impl.UserElementTypeImpl#getValidFor <em>Valid For</em>}</li>
 *   <li>{@link eastadl22_alpha.impl.UserElementTypeImpl#getKey <em>Key</em>}</li>
 *   <li>{@link eastadl22_alpha.impl.UserElementTypeImpl#getUaDefinition <em>Ua Definition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UserElementTypeImpl extends EAPackageableElementImpl implements UserElementType {
	...
	protected EClass eStaticClass() {
		return Eastadl22_alphaPackage.Literals.USER_ELEMENT_TYPE;
	}
	...
	public void setValidFor(String newValidFor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.USER_ELEMENT_TYPE__VALID_FOR, oldValidFor, validFor, !oldValidForESet));
	}
	...
	public void unsetValidFor() {
		...
		validForESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Eastadl22_alphaPackage.USER_ELEMENT_TYPE__VALID_FOR, oldValidFor, VALID_FOR_EDEFAULT, oldValidForESet));
	}
	...
	public void setKey(String newKey) {
		...
		keyESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.USER_ELEMENT_TYPE__KEY, oldKey, key, !oldKeyESet));
	}
	...
	public void unsetKey() {
		...
		keyESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Eastadl22_alphaPackage.USER_ELEMENT_TYPE__KEY, oldKey, KEY_EDEFAULT, oldKeyESet));
	}
	...
	public EList<UserAttributeDefinition> getUaDefinition() {
		if (uaDefinition == null) {
			uaDefinition = new EObjectContainmentEList<UserAttributeDefinition>(UserAttributeDefinition.class, this, Eastadl22_alphaPackage.USER_ELEMENT_TYPE__UA_DEFINITION);
		}
		return uaDefinition;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Eastadl22_alphaPackage.USER_ELEMENT_TYPE__UA_DEFINITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Eastadl22_alphaPackage.USER_ELEMENT_TYPE__VALID_FOR:
				return getValidFor();
			case Eastadl22_alphaPackage.USER_ELEMENT_TYPE__KEY:
				return getKey();
			case Eastadl22_alphaPackage.USER_ELEMENT_TYPE__UA_DEFINITION:
