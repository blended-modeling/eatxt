 ...
 * </p>
 * <ul>
 *   <li>{@link eastadl22_alpha.impl.DesignFunctionTypeImpl#getPart <em>Part</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DesignFunctionTypeImpl extends FunctionTypeImpl implements DesignFunctionType {
	...
	protected EClass eStaticClass() {
		return Eastadl22_alphaPackage.Literals.DESIGN_FUNCTION_TYPE;
	}
	...
	public EList<DesignFunctionPrototype> getPart() {
		if (part == null) {
			part = new EObjectContainmentEList<DesignFunctionPrototype>(DesignFunctionPrototype.class, this, Eastadl22_alphaPackage.DESIGN_FUNCTION_TYPE__PART);
		}
		return part;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Eastadl22_alphaPackage.DESIGN_FUNCTION_TYPE__PART:
