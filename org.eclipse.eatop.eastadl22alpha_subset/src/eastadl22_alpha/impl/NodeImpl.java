 ...
 * </p>
 * <ul>
 *   <li>{@link eastadl22_alpha.impl.NodeImpl#getExecutionRate <em>Execution Rate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NodeImpl extends HardwareComponentTypeImpl implements Node {
	...
	protected EClass eStaticClass() {
		return Eastadl22_alphaPackage.Literals.NODE;
	}
	...
	public void setExecutionRate(Double newExecutionRate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.NODE__EXECUTION_RATE, oldExecutionRate, executionRate, !oldExecutionRateESet));
	}
	...
	public void unsetExecutionRate() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Eastadl22_alphaPackage.NODE__EXECUTION_RATE, oldExecutionRate, EXECUTION_RATE_EDEFAULT, oldExecutionRateESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Eastadl22_alphaPackage.NODE__EXECUTION_RATE:
