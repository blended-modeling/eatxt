 ...
 * </p>
 * <ul>
 *   <li>{@link eastadl22_alpha.impl.AnalysisFunctionPrototypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnalysisFunctionPrototypeImpl extends FunctionPrototypeImpl implements AnalysisFunctionPrototype {
	...
	protected EClass eStaticClass() {
		return Eastadl22_alphaPackage.Literals.ANALYSIS_FUNCTION_PROTOTYPE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Eastadl22_alphaPackage.ANALYSIS_FUNCTION_PROTOTYPE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(AnalysisFunctionType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.ANALYSIS_FUNCTION_PROTOTYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Eastadl22_alphaPackage.ANALYSIS_FUNCTION_PROTOTYPE__TYPE:
