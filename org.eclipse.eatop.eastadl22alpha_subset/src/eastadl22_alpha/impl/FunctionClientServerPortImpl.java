 ...
 * </p>
 * <ul>
 *   <li>{@link eastadl22_alpha.impl.FunctionClientServerPortImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link eastadl22_alpha.impl.FunctionClientServerPortImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionClientServerPortImpl extends FunctionPortImpl implements FunctionClientServerPort {
	...
	protected EClass eStaticClass() {
		return Eastadl22_alphaPackage.Literals.FUNCTION_CLIENT_SERVER_PORT;
	}
	...
	public void setKind(ClientServerKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.FUNCTION_CLIENT_SERVER_PORT__KIND, oldKind, kind, !oldKindESet));
	}
	...
	public void unsetKind() {
		...
		kindESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Eastadl22_alphaPackage.FUNCTION_CLIENT_SERVER_PORT__KIND, oldKind, KIND_EDEFAULT, oldKindESet));
	}
	...
	public FunctionClientServerInterface getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Eastadl22_alphaPackage.FUNCTION_CLIENT_SERVER_PORT__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(FunctionClientServerInterface newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.FUNCTION_CLIENT_SERVER_PORT__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Eastadl22_alphaPackage.FUNCTION_CLIENT_SERVER_PORT__KIND:
				return getKind();
			case Eastadl22_alphaPackage.FUNCTION_CLIENT_SERVER_PORT__TYPE:
