 ...
 * </p>
 * <ul>
 *   <li>{@link eastadl22_alpha.impl.QuantityImpl#getAmountOfSubstanceExp <em>Amount Of Substance Exp</em>}</li>
 *   <li>{@link eastadl22_alpha.impl.QuantityImpl#getElectricCurrentExp <em>Electric Current Exp</em>}</li>
 *   <li>{@link eastadl22_alpha.impl.QuantityImpl#getLengthExp <em>Length Exp</em>}</li>
 *   <li>{@link eastadl22_alpha.impl.QuantityImpl#getLuminousIntensityExp <em>Luminous Intensity Exp</em>}</li>
 *   <li>{@link eastadl22_alpha.impl.QuantityImpl#getMassExp <em>Mass Exp</em>}</li>
 *   <li>{@link eastadl22_alpha.impl.QuantityImpl#getThermodynamicTemperatureExp <em>Thermodynamic Temperature Exp</em>}</li>
 *   <li>{@link eastadl22_alpha.impl.QuantityImpl#getTimeExp <em>Time Exp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QuantityImpl extends EAPackageableElementImpl implements Quantity {
	...
	protected EClass eStaticClass() {
		return Eastadl22_alphaPackage.Literals.QUANTITY;
	}
	...
	public void setAmountOfSubstanceExp(Integer newAmountOfSubstanceExp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.QUANTITY__AMOUNT_OF_SUBSTANCE_EXP, oldAmountOfSubstanceExp, amountOfSubstanceExp, !oldAmountOfSubstanceExpESet));
	}
	...
	public void unsetAmountOfSubstanceExp() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Eastadl22_alphaPackage.QUANTITY__AMOUNT_OF_SUBSTANCE_EXP, oldAmountOfSubstanceExp, AMOUNT_OF_SUBSTANCE_EXP_EDEFAULT, oldAmountOfSubstanceExpESet));
	}
	...
	public void setElectricCurrentExp(Integer newElectricCurrentExp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.QUANTITY__ELECTRIC_CURRENT_EXP, oldElectricCurrentExp, electricCurrentExp, !oldElectricCurrentExpESet));
	}
	...
	public void unsetElectricCurrentExp() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Eastadl22_alphaPackage.QUANTITY__ELECTRIC_CURRENT_EXP, oldElectricCurrentExp, ELECTRIC_CURRENT_EXP_EDEFAULT, oldElectricCurrentExpESet));
	}
	...
	public void setLengthExp(Integer newLengthExp) {
		...
		lengthExpESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.QUANTITY__LENGTH_EXP, oldLengthExp, lengthExp, !oldLengthExpESet));
	}
	...
	public void unsetLengthExp() {
		...
		lengthExpESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Eastadl22_alphaPackage.QUANTITY__LENGTH_EXP, oldLengthExp, LENGTH_EXP_EDEFAULT, oldLengthExpESet));
	}
	...
	public void setLuminousIntensityExp(Integer newLuminousIntensityExp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.QUANTITY__LUMINOUS_INTENSITY_EXP, oldLuminousIntensityExp, luminousIntensityExp, !oldLuminousIntensityExpESet));
	}
	...
	public void unsetLuminousIntensityExp() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Eastadl22_alphaPackage.QUANTITY__LUMINOUS_INTENSITY_EXP, oldLuminousIntensityExp, LUMINOUS_INTENSITY_EXP_EDEFAULT, oldLuminousIntensityExpESet));
	}
	...
	public void setMassExp(Integer newMassExp) {
		...
		massExpESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.QUANTITY__MASS_EXP, oldMassExp, massExp, !oldMassExpESet));
	}
	...
	public void unsetMassExp() {
		...
		massExpESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Eastadl22_alphaPackage.QUANTITY__MASS_EXP, oldMassExp, MASS_EXP_EDEFAULT, oldMassExpESet));
	}
	...
	public void setThermodynamicTemperatureExp(Integer newThermodynamicTemperatureExp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.QUANTITY__THERMODYNAMIC_TEMPERATURE_EXP, oldThermodynamicTemperatureExp, thermodynamicTemperatureExp, !oldThermodynamicTemperatureExpESet));
	}
	...
	public void unsetThermodynamicTemperatureExp() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Eastadl22_alphaPackage.QUANTITY__THERMODYNAMIC_TEMPERATURE_EXP, oldThermodynamicTemperatureExp, THERMODYNAMIC_TEMPERATURE_EXP_EDEFAULT, oldThermodynamicTemperatureExpESet));
	}
	...
	public void setTimeExp(Integer newTimeExp) {
		...
		timeExpESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl22_alphaPackage.QUANTITY__TIME_EXP, oldTimeExp, timeExp, !oldTimeExpESet));
	}
	...
	public void unsetTimeExp() {
		...
		timeExpESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Eastadl22_alphaPackage.QUANTITY__TIME_EXP, oldTimeExp, TIME_EXP_EDEFAULT, oldTimeExpESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Eastadl22_alphaPackage.QUANTITY__AMOUNT_OF_SUBSTANCE_EXP:
				return getAmountOfSubstanceExp();
			case Eastadl22_alphaPackage.QUANTITY__ELECTRIC_CURRENT_EXP:
				return getElectricCurrentExp();
			case Eastadl22_alphaPackage.QUANTITY__LENGTH_EXP:
				return getLengthExp();
			case Eastadl22_alphaPackage.QUANTITY__LUMINOUS_INTENSITY_EXP:
				return getLuminousIntensityExp();
			case Eastadl22_alphaPackage.QUANTITY__MASS_EXP:
				return getMassExp();
			case Eastadl22_alphaPackage.QUANTITY__THERMODYNAMIC_TEMPERATURE_EXP:
				return getThermodynamicTemperatureExp();
			case Eastadl22_alphaPackage.QUANTITY__TIME_EXP:
				return getTimeExp();
		}
