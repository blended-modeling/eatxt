...
public class FileOperateHelper {
	...
	private static final String TEST_PROJECT_NAME = "org.bumble.eastadl.simplified.tests";
	private static final String EXAMPLE_PROJECT_NAME = "org.bumble.eastadl.simplified.examples";
