...
/**
 * This is the item provider adapter for a {@link org.eclipse.eatop.eastadl21.EAElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EAElementItemProvider extends IdentifiableItemProvider {
	/**
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EAElement.class)) {
			case Eastadl21Package.EA_ELEMENT__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case Eastadl21Package.EA_ELEMENT__OWNED_COMMENT:
