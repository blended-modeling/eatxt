...
/**
 * This is the item provider adapter for a {@link org.eclipse.eatop.eastadl21.UserAttributeDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserAttributeDefinitionItemProvider extends EAPackageableElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Eastadl21Package.Literals.USER_ATTRIBUTE_DEFINITION__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Eastadl21Package.Literals.USER_ATTRIBUTE_DEFINITION__DEFAULT_VALUE);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_UserAttributeDefinition_type") :
			getString("_UI_UserAttributeDefinition_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Eastadl21Package.Literals.USER_ATTRIBUTE_DEFINITION__DEFAULT_VALUE,
