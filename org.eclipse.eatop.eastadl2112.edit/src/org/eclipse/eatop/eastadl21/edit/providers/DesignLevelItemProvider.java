...
/**
 * This is the item provider adapter for a {@link org.eclipse.eatop.eastadl21.DesignLevel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DesignLevelItemProvider extends ContextItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Eastadl21Package.Literals.DESIGN_LEVEL__ALLOCATION);
			childrenFeatures.add(Eastadl21Package.Literals.DESIGN_LEVEL__FUNCTIONAL_DESIGN_ARCHITECTURE);
			childrenFeatures.add(Eastadl21Package.Literals.DESIGN_LEVEL__HARDWARE_DESIGN_ARCHITECTURE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Eastadl21Package.Literals.DESIGN_LEVEL__ALLOCATION,
				 Eastadl21Factory.eINSTANCE.createAllocation()));

		newChildDescriptors.add
			(createChildParameter
				(Eastadl21Package.Literals.DESIGN_LEVEL__FUNCTIONAL_DESIGN_ARCHITECTURE,
				 Eastadl21Factory.eINSTANCE.createDesignFunctionPrototype()));

		newChildDescriptors.add
			(createChildParameter
				(Eastadl21Package.Literals.DESIGN_LEVEL__HARDWARE_DESIGN_ARCHITECTURE,
