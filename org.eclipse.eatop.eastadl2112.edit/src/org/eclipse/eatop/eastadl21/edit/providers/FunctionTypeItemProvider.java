...
/**
 * This is the item provider adapter for a {@link org.eclipse.eatop.eastadl21.FunctionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionTypeItemProvider extends ContextItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Eastadl21Package.Literals.FUNCTION_TYPE__IS_ELEMENTARY,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Eastadl21Package.Literals.FUNCTION_TYPE__PORT_GROUP);
			childrenFeatures.add(Eastadl21Package.Literals.FUNCTION_TYPE__CONNECTOR);
			childrenFeatures.add(Eastadl21Package.Literals.FUNCTION_TYPE__PORT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Eastadl21Package.Literals.FUNCTION_TYPE__PORT_GROUP,
				 Eastadl21Factory.eINSTANCE.createPortGroup()));

		newChildDescriptors.add
			(createChildParameter
				(Eastadl21Package.Literals.FUNCTION_TYPE__CONNECTOR,
				 Eastadl21Factory.eINSTANCE.createFunctionConnector()));

		newChildDescriptors.add
			(createChildParameter
				(Eastadl21Package.Literals.FUNCTION_TYPE__PORT,
				 Eastadl21Factory.eINSTANCE.createFunctionClientServerPort()));

		newChildDescriptors.add
			(createChildParameter
				(Eastadl21Package.Literals.FUNCTION_TYPE__PORT,
				 Eastadl21Factory.eINSTANCE.createFunctionFlowPort()));

		newChildDescriptors.add
			(createChildParameter
				(Eastadl21Package.Literals.FUNCTION_TYPE__PORT,
				 Eastadl21Factory.eINSTANCE.createFunctionPowerPort()));
	}
