 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.eatop.eastadl21.impl.ElectricalComponentImpl#getIsActive <em>Is Active</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElectricalComponentImpl extends HardwareComponentTypeImpl implements ElectricalComponent {
	...
	protected EClass eStaticClass() {
		return Eastadl21Package.Literals.ELECTRICAL_COMPONENT;
	}
	...
	public void setIsActive(Boolean newIsActive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl21Package.ELECTRICAL_COMPONENT__IS_ACTIVE, oldIsActive, isActive, !oldIsActiveESet));
	}
	...
	public void unsetIsActive() {
		...
		isActiveESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Eastadl21Package.ELECTRICAL_COMPONENT__IS_ACTIVE, oldIsActive, IS_ACTIVE_EDEFAULT, oldIsActiveESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Eastadl21Package.ELECTRICAL_COMPONENT__IS_ACTIVE:
				return getIsActive();
		}
