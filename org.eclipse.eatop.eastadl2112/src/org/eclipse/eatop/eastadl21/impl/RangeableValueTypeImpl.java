 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.eatop.eastadl21.impl.RangeableValueTypeImpl#getAccuracy <em>Accuracy</em>}</li>
 *   <li>{@link org.eclipse.eatop.eastadl21.impl.RangeableValueTypeImpl#getResolution <em>Resolution</em>}</li>
 *   <li>{@link org.eclipse.eatop.eastadl21.impl.RangeableValueTypeImpl#getSignificantDigits <em>Significant Digits</em>}</li>
 *   <li>{@link org.eclipse.eatop.eastadl21.impl.RangeableValueTypeImpl#getBaseRangeable <em>Base Rangeable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RangeableValueTypeImpl extends EADatatypeImpl implements RangeableValueType {
	...
	protected EClass eStaticClass() {
		return Eastadl21Package.Literals.RANGEABLE_VALUE_TYPE;
	}
	...
	public void setAccuracy(Double newAccuracy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl21Package.RANGEABLE_VALUE_TYPE__ACCURACY, oldAccuracy, accuracy, !oldAccuracyESet));
	}
	...
	public void unsetAccuracy() {
		...
		accuracyESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Eastadl21Package.RANGEABLE_VALUE_TYPE__ACCURACY, oldAccuracy, ACCURACY_EDEFAULT, oldAccuracyESet));
	}
	...
	public void setResolution(Double newResolution) {
		...
		resolutionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl21Package.RANGEABLE_VALUE_TYPE__RESOLUTION, oldResolution, resolution, !oldResolutionESet));
	}
	...
	public void unsetResolution() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Eastadl21Package.RANGEABLE_VALUE_TYPE__RESOLUTION, oldResolution, RESOLUTION_EDEFAULT, oldResolutionESet));
	}
	...
	public void setSignificantDigits(Integer newSignificantDigits) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl21Package.RANGEABLE_VALUE_TYPE__SIGNIFICANT_DIGITS, oldSignificantDigits, significantDigits, !oldSignificantDigitsESet));
	}
	...
	public void unsetSignificantDigits() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Eastadl21Package.RANGEABLE_VALUE_TYPE__SIGNIFICANT_DIGITS, oldSignificantDigits, SIGNIFICANT_DIGITS_EDEFAULT, oldSignificantDigitsESet));
	}
	...
	public EANumerical getBaseRangeable() {
		if (baseRangeable != null && baseRangeable.eIsProxy()) {
			...
			if (baseRangeable != oldBaseRangeable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Eastadl21Package.RANGEABLE_VALUE_TYPE__BASE_RANGEABLE, oldBaseRangeable, baseRangeable));
			}
		}
	...
	public void setBaseRangeable(EANumerical newBaseRangeable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl21Package.RANGEABLE_VALUE_TYPE__BASE_RANGEABLE, oldBaseRangeable, baseRangeable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Eastadl21Package.RANGEABLE_VALUE_TYPE__BASE_RANGEABLE:
