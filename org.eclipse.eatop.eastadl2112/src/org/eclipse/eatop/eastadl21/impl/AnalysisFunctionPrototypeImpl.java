 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.eatop.eastadl21.impl.AnalysisFunctionPrototypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnalysisFunctionPrototypeImpl extends FunctionPrototypeImpl implements AnalysisFunctionPrototype {
	...
	protected EClass eStaticClass() {
		return Eastadl21Package.Literals.ANALYSIS_FUNCTION_PROTOTYPE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Eastadl21Package.ANALYSIS_FUNCTION_PROTOTYPE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(AnalysisFunctionType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl21Package.ANALYSIS_FUNCTION_PROTOTYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Eastadl21Package.ANALYSIS_FUNCTION_PROTOTYPE__TYPE:
