 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.eatop.eastadl21.impl.HardwareComponentTypeImpl#getPin <em>Pin</em>}</li>
 *   <li>{@link org.eclipse.eatop.eastadl21.impl.HardwareComponentTypeImpl#getPart <em>Part</em>}</li>
 *   <li>{@link org.eclipse.eatop.eastadl21.impl.HardwareComponentTypeImpl#getConnector <em>Connector</em>}</li>
 *   <li>{@link org.eclipse.eatop.eastadl21.impl.HardwareComponentTypeImpl#getPort <em>Port</em>}</li>
 *   <li>{@link org.eclipse.eatop.eastadl21.impl.HardwareComponentTypeImpl#getPortConnector <em>Port Connector</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HardwareComponentTypeImpl extends ContextImpl implements HardwareComponentType {
	...
	protected EClass eStaticClass() {
		return Eastadl21Package.Literals.HARDWARE_COMPONENT_TYPE;
	}
	...
	public EList<HardwarePin> getPin() {
		if (pin == null) {
			pin = new EObjectContainmentEList<HardwarePin>(HardwarePin.class, this, Eastadl21Package.HARDWARE_COMPONENT_TYPE__PIN);
		}
		return pin;
	}
	...
	public EList<HardwareComponentPrototype> getPart() {
		if (part == null) {
			part = new EObjectContainmentEList<HardwareComponentPrototype>(HardwareComponentPrototype.class, this, Eastadl21Package.HARDWARE_COMPONENT_TYPE__PART);
		}
		return part;
	}
	...
	public EList<HardwareConnector> getConnector() {
		if (connector == null) {
			connector = new EObjectContainmentEList<HardwareConnector>(HardwareConnector.class, this, Eastadl21Package.HARDWARE_COMPONENT_TYPE__CONNECTOR);
		}
		return connector;
	}
	...
	public EList<HardwarePort> getPort() {
		if (port == null) {
			port = new EObjectContainmentEList<HardwarePort>(HardwarePort.class, this, Eastadl21Package.HARDWARE_COMPONENT_TYPE__PORT);
		}
		return port;
	}
	...
	public EList<PortConnector> getPortConnector() {
		if (portConnector == null) {
			portConnector = new EObjectContainmentEList<PortConnector>(PortConnector.class, this, Eastadl21Package.HARDWARE_COMPONENT_TYPE__PORT_CONNECTOR);
		}
