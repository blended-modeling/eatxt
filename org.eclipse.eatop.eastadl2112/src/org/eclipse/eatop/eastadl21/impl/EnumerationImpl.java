 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.eatop.eastadl21.impl.EnumerationImpl#getIsMultiValued <em>Is Multi Valued</em>}</li>
 *   <li>{@link org.eclipse.eatop.eastadl21.impl.EnumerationImpl#getLiteral <em>Literal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumerationImpl extends EADatatypeImpl implements Enumeration {
	...
	protected EClass eStaticClass() {
		return Eastadl21Package.Literals.ENUMERATION;
	}
	...
	public void setIsMultiValued(Boolean newIsMultiValued) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl21Package.ENUMERATION__IS_MULTI_VALUED, oldIsMultiValued, isMultiValued, !oldIsMultiValuedESet));
	}
	...
	public void unsetIsMultiValued() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Eastadl21Package.ENUMERATION__IS_MULTI_VALUED, oldIsMultiValued, IS_MULTI_VALUED_EDEFAULT, oldIsMultiValuedESet));
	}
	...
	public EList<EnumerationLiteral> getLiteral() {
		if (literal == null) {
			literal = new EObjectContainmentEList<EnumerationLiteral>(EnumerationLiteral.class, this, Eastadl21Package.ENUMERATION__LITERAL);
		}
		return literal;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Eastadl21Package.ENUMERATION__LITERAL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Eastadl21Package.ENUMERATION__IS_MULTI_VALUED:
