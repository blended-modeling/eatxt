 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.eatop.eastadl21.impl.FunctionPowerPortImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionPowerPortImpl extends FunctionPortImpl implements FunctionPowerPort {
	...
	protected EClass eStaticClass() {
		return Eastadl21Package.Literals.FUNCTION_POWER_PORT;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Eastadl21Package.FUNCTION_POWER_PORT__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(CompositeDatatype newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl21Package.FUNCTION_POWER_PORT__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Eastadl21Package.FUNCTION_POWER_PORT__TYPE:
