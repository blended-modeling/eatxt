 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.eatop.eastadl21.impl.Realization_realizedByImpl#getIdentifiable_target <em>Identifiable target</em>}</li>
 *   <li>{@link org.eclipse.eatop.eastadl21.impl.Realization_realizedByImpl#getIdentifiable_context <em>Identifiable context</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Realization_realizedByImpl extends ExtendedEObjectImpl implements Realization_realizedBy {
	...
	protected EClass eStaticClass() {
		return Eastadl21Package.Literals.REALIZATION_REALIZED_BY;
	}
		...
		if (identifiable_target != null && identifiable_target.eIsProxy()) {
			...
			if (identifiable_target != oldIdentifiable_target) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Eastadl21Package.REALIZATION_REALIZED_BY__IDENTIFIABLE_TARGET, oldIdentifiable_target, identifiable_target));
			}
		}
	...
	public void setIdentifiable_target(Identifiable newIdentifiable_target) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl21Package.REALIZATION_REALIZED_BY__IDENTIFIABLE_TARGET, oldIdentifiable_target, identifiable_target));
	}
	...
	public EList<Identifiable> getIdentifiable_context() {
		if (identifiable_context == null) {
			identifiable_context = new EObjectResolvingEList<Identifiable>(Identifiable.class, this, Eastadl21Package.REALIZATION_REALIZED_BY__IDENTIFIABLE_CONTEXT);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Eastadl21Package.REALIZATION_REALIZED_BY__IDENTIFIABLE_TARGET:
				if (resolve) return getIdentifiable_target();
				return basicGetIdentifiable_target();
			case Eastadl21Package.REALIZATION_REALIZED_BY__IDENTIFIABLE_CONTEXT:
