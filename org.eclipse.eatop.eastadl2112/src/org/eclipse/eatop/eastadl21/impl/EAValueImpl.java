 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.eatop.eastadl21.impl.EAValueImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class EAValueImpl extends ExtendedEObjectImpl implements EAValue {
	/**
	...
	protected EClass eStaticClass() {
		return Eastadl21Package.Literals.EA_VALUE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Eastadl21Package.EA_VALUE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(EADatatype newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Eastadl21Package.EA_VALUE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Eastadl21Package.EA_VALUE__TYPE:
